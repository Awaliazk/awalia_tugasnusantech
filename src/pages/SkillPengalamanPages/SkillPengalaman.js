...
const SkillPengalaman = () => {
  ...
  const [htmlSkill, setHtmlSkill] = useState(50);
  const [cssSkill, setCssSkill] = useState(20);
  const [jsSkill, setJsSkill] = useState(30);
  const [reactSkill, setReactSkill] = useState(20); // State untuk React skill
